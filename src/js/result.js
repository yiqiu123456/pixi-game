import {
  Texture, Container, Sprite, Text, Graphics, TextStyle
} from 'pixi.js'
...
export default class Result extends Container {
  constructor() {
    ...
    let win_text = new Text(app.i18n.get('result.win', {prize: app.i18n.get('prize.win')}), 
    new TextStyle({
      fontFamily: 'Arial',
      fontSize: 40,
      fontWeight: 'bold',
    ...
    let fail_text = new Text(app.i18n.get('result.fail', { prize: app.i18n.get('prize.fail') }),
    new TextStyle({
      fontFamily: 'Arial',
      fontSize: 40,
      fontWeight: 'bold',
